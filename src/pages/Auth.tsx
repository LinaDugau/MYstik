...
export default function Auth() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const registerUsername = username.trim();
    const registerName = name.trim();
    ...
    if (isLogin) {
      ...
      if (!loginValue || !registerUsername || !passwordValue || !registerName) {
    ...
    try {
      const success = isLogin
        ...
        : await register(loginValue, registerUsername, passwordValue, registerName, birthDate || undefined);
